...
public class List
{
    ...
    public static string[] numbers = new string[10] { "Hidrogênio",
                                                      "16",
                                                      "Cloro",
                                                      "Carbono",
                                                      "10",
    ...
    public static string[] symbols = new string[10] { "Potássio",
                                                      "H",
                                                      "Sódio",
                                                      "B",
                                                      "Cobre",
    ...
    public static string[] names = new string[10] { "H",
                                                    "P",
                                                    "C",
                                                    "Elemento radioativo",
                                                    "N",
                                                    "Transporta oxigénio pelas hemoglobinas",
                                                    "F",
                                                    "Essencial para respiração",
                                                    "K",
                                                    "Pb" }; // perguntas
    ...
    public static string[] mass = new string[10] { "Hidrogênio",
                                                   "Sódio",
                                                   "Carbono",
                                                   "Potássio",
                                                   "Oxigênio",
    ...
    public static string[] period = new string[10] { "Hidrogênio",
                                                     "Potássio",
                                                     "Carbono",
                                                     "Ferro",
                                                     "Hélio",
